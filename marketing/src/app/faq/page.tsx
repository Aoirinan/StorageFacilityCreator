...
const FAQ_ITEMS = [
  {
    ...
    qas: [
      ...
      { q: 'Do you offer a free trial?', a: 'Yes. Every new subscription starts with a 30-day trial, and the first monthly invoice after the trial is free. You sign up directly in the app, with no sales call required.' },
      { q: 'Is a credit card required to request a demo?', a: 'No. You can request a demo and review fit before committing to a paid subscription. A payment method is collected when you start a trial in the app, but it is not charged until the trial and your free first month have ended.' },
  ...
  },
  {
    ...
    qas: [
      ...
      { q: 'What third-party providers does SFC use?', a: 'Stripe for payments, Twilio for SMS, SendGrid for email, Google Cloud/Firebase for hosting and data, and Intuit for the optional QuickBooks sync. The full list, with what each provider receives, is on the Subprocessors page.' },
  ...
  },
  {
    ...
    qas: [
      { q: 'Does SFC support electronic signatures?', a: 'Yes. Rental agreements and other documents can be sent for electronic signature and signed from any device, with the signed copy stored on the tenant record. Our E-Sign Disclosure page explains what tenants agree to.' },
      ...
      { q: 'Does SFC include a tenant portal?', a: 'Yes. Tenants can view their balance, make a payment, and manage autopay from a portal link you share with them.' },
      { q: 'Does SFC support online rentals or move-ins?', a: 'Yes. With the optional website add-on, prospects can pick a unit, sign the agreement, and pay online from your public facility page, and the move-in lands in your dashboard with no re-keying.' },
    ],
  },
  {
    category: 'Integrations',
    qas: [
      { q: 'Does SFC integrate with QuickBooks?', a: 'Yes. Connect your QuickBooks Online account and SFC syncs invoices and payments to it automatically, so your books stay current without manual entry.' },
