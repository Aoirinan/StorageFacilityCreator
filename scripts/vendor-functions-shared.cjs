...
const packages = ['functions', 'functions-ai', 'functions-marketing', 'functions-integrations', 'functions-admin', 'functions-public-website', 'functions-tenant-lifecycle', 'functions-automation', 'functions-facility-ops'];
