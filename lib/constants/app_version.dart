...
class AppVersion {
  ...
  static const String version = '2.10.18';

  // Build number (YYYYMMDD format for easy identification)
  static const String buildNumber = '20260414';

  // Full version string
  static const String fullVersion = '$version+$buildNumber';

  // Deployment date/time (update on each deploy)
  static const String deploymentDate = '2026-04-14';
  ...
  static const String featureTag =
      'App subdomain: marketing on Vercel only; app.* opens login; mirror legal pages redirect to main site';
