...
class _FAQ extends StatelessWidget {
  final faqs = const [
    ...
    ('Can we migrate data?', 'Yes. Your tenant list comes over through a guided CSV import, and any unit number it does not recognize is created as it goes. Units can also be created in bulk by number range. Outstanding balances are entered after the import rather than imported, and we can help with the migration.'),
